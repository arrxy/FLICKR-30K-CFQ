...
if __name__ == '__main__':
    text_to_raw_enchanced = json.load(open('data/text_to_raw_enhanced_2.json', 'r', encoding='utf-8'))
    ...
    json.dump(new_text_to_enhanced, open('data/text_to_enhanced_list_2.json', 'w', encoding='utf-8'), ensure_ascii=False)