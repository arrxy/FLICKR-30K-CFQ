...
if __name__ == '__main__':
    ...
    new_text_to_enhanced = json.load(open('data/text_to_enhanced_list.json', 'r', encoding='utf-8'))
    ...
    for model_name in tqdm(model_name_list):
        ...
        torch.save(all_text_features, 'data/enhanced_text_features_{}.pt'.format(model_name))
